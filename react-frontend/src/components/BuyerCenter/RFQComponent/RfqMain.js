        ...
        <>
            <section className="content-main inquiries-container">
                <div className="bc-title-container w-full">
                    <h4 className="font-semibold">My Request</h4>
                </div>
                ...
                <TabView>
                    <TabPanel header="All">
                        ...
                        <DataTable className="mt-5" value={inquiries} selection={selectedInquiries} onSelectionChange={(e) => setSelectedInquiries(e.value)}>
                            ...
                            <Column field="inquiryDetails" header="Quotations" />
                            <Column field="supplier" header="Expires" />
                            <Column field="message" header="Post Date" />
                            <Column field="updateTime" header="State" />
                        </DataTable>
                    </TabPanel>
